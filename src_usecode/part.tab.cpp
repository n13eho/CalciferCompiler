...
{
       0,    34,    34,    86,    91,    92,    97,    98,   103,   104,
     105,   110,   111,   112,   117,   118,   119,   123,   124,   129,
     130,   135,   136,   137,   138,   143,   144,   145,   150,   151,
     152,   153
};
#endif
...
static const char *const yytname[] =
{
  ...
  "$accept", "program", "Exp", "LVal", "Exps", "PrimaryExp", "UnaryExp",
...
{
     -34,     2,    12,   -35,    -5,    19,   -35,    -5,   -35,   -35,
     -35,   -35,   -35,   -35,   -35,     3,     9,   -35,   -35,   -35,
      -5,   -12,    10,   -35,    -5,    13,    -5,   -35,   -35,    -5,
      -5,    -5,    -5,    -5,    21,   -35,   -35,    24,    27,   -35,
     -35,   -35,   -12,   -12,   -35,   -35,    -5,   -35
};
...
{
       0,     5,     0,     2,     0,     4,     1,     0,    14,    15,
      16,    31,    28,    29,    30,     5,     0,     9,    11,    21,
       0,    25,     3,    10,     0,     0,    17,     6,    13,     0,
       0,     0,     0,     0,     0,     8,    19,     0,    18,    23,
      22,    24,    26,    27,     7,    12,     0,    20
};

  /* YYPGOTO[NTERM-NUM].  */
static const yytype_int8 yypgoto[] =
{
     -35,   -35,    -7,    33,   -35,   -35,   -15,   -35,   -35,   -35,
      -4,   -35,   -35
};
...
{
      25,     7,    29,    30,    31,    28,     1,     8,     9,    26,
       4,     4,     6,    10,    39,    40,    41,    34,    27,    36,
      35,    11,    32,    33,    12,    13,    14,    24,    42,    43,
      44,    45,    46,     3,     0,    15,     0,     0,     0,    47
};

static const yytype_int8 yycheck[] =
{
       7,     6,    14,    15,    16,    20,    40,    12,    13,     6,
       8,     8,     0,    18,    29,    30,    31,    24,     9,    26,
       7,    26,    12,    13,    29,    30,    31,     8,    32,    33,
       9,     7,     5,     0,    -1,    40,    -1,    -1,    -1,    46
};
...
{
       0,    40,    42,    44,     8,    45,     0,     6,    12,    13,
      18,    26,    29,    30,    31,    40,    43,    44,    46,    47,
      48,    51,    52,    53,     8,    43,     6,     9,    47,    14,
      15,    16,    12,    13,    43,     7,    43,    49,    50,    47,
      47,    47,    51,    51,     9,     7,     5,    43
};
...
#line 1381 "part.tab.cpp"
    break;

  case 4:
#line 91 "part.ypp"
                                                        {(yyval.no) = new GrammaNode(LVal_,"LVal_"); (yyval.no)->son.push_back((yyvsp[-1].no));(yyval.no)->son.push_back((yyvsp[0].no));show_node((yyval.no));}
#line 1387 "part.tab.cpp"
    break;

  case 5:
#line 92 "part.ypp"
                                                        {(yyval.no) = new GrammaNode(LVal_,"LVal_"); (yyval.no)->son.push_back((yyvsp[0].no));show_node((yyval.no));printf("LAal->Ident\n");}
#line 1393 "part.tab.cpp"
    break;
...
#line 1405 "part.tab.cpp"
    break;

  case 8:
#line 103 "part.ypp"
                                {(yyval.no) = new GrammaNode(PrimaryExp_,"PrimaryExp"); (yyval.no)->son.push_back((yyvsp[-2].no));(yyval.no)->son.push_back((yyvsp[-1].no));(yyval.no)->son.push_back((yyvsp[0].no));show_node((yyval.no));}
#line 1411 "part.tab.cpp"
    break;

  case 9:
#line 104 "part.ypp"
                                                        {(yyval.no) = new GrammaNode(PrimaryExp_,"PrimaryExp"); (yyval.no)->son.push_back((yyvsp[0].no));show_node((yyval.no));}
#line 1417 "part.tab.cpp"
    break;

  case 10:
#line 105 "part.ypp"
                                                        {(yyval.no) = new GrammaNode(PrimaryExp_,"PrimaryExp"); (yyval.no)->son.push_back((yyvsp[0].no));show_node((yyval.no));}
#line 1423 "part.tab.cpp"
    break;

  case 11:
#line 110 "part.ypp"
                                                                {(yyval.no) = new GrammaNode(UnaryExp_,"UnaryExp_"); (yyval.no)->son.push_back((yyvsp[0].no));}
#line 1429 "part.tab.cpp"
    break;
...
#line 1489 "part.tab.cpp"
    break;

  case 23:
#line 137 "part.ypp"
                                {(yyval.no) = new GrammaNode(MulExp_,"MulExp_"); (yyval.no)->son.push_back((yyvsp[-2].no));(yyval.no)->son.push_back((yyvsp[-1].no));(yyval.no)->son.push_back((yyvsp[0].no));}
#line 1495 "part.tab.cpp"
    break;

  case 24:
#line 138 "part.ypp"
                                {(yyval.no) = new GrammaNode(MulExp_,"MulExp_"); (yyval.no)->son.push_back((yyvsp[-2].no));(yyval.no)->son.push_back((yyvsp[-1].no));(yyval.no)->son.push_back((yyvsp[0].no));}
#line 1501 "part.tab.cpp"
    break;

  case 25:
#line 143 "part.ypp"
                                        {(yyval.no) = new GrammaNode(AddExp_,"AddExp"); (yyval.no)->son.push_back((yyvsp[0].no));}
#line 1507 "part.tab.cpp"
    break;
...
#line 1513 "part.tab.cpp"
    break;

  case 27:
#line 145 "part.ypp"
                                {(yyval.no) = new GrammaNode(AddExp_,"AddExp"); (yyval.no)->son.push_back((yyvsp[-2].no));(yyval.no)->son.push_back((yyvsp[-1].no));(yyval.no)->son.push_back((yyvsp[0].no));}
#line 1519 "part.tab.cpp"
    break;

  case 28:
#line 150 "part.ypp"
                        {(yyval.no) = new GrammaNode(IntConst_,"IntConst"); (yyval.no)->son.push_back((yyvsp[0].no));}
#line 1525 "part.tab.cpp"
    break;

  case 29:
#line 151 "part.ypp"
                        {(yyval.no) = new GrammaNode(IntConst_,"IntConst"); (yyval.no)->son.push_back((yyvsp[0].no));}
#line 1531 "part.tab.cpp"
    break;

  case 30:
#line 152 "part.ypp"
                        {(yyval.no) = new GrammaNode(IntConst_,"IntConst"); (yyval.no)->son.push_back((yyvsp[0].no));}
#line 1537 "part.tab.cpp"
    break;

  case 31:
#line 153 "part.ypp"
                                {(yyval.no) = new GrammaNode(IntConst_,"IntConst"); (yyval.no)->son.push_back((yyvsp[0].no));}
#line 1543 "part.tab.cpp"
    break;
