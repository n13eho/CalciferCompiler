...
if __name__ == '__main__':
  report_fileName = "performance " + time.strftime("%m%d_%H:%M", time.localtime()) + ".txt"
  ...
  parser.add_argument("-test_path", type=str, help="the path of the test cases with glob style.", default="./_performance_test2021/*")
  ...
  asmFolder = './asm_output_perf'
  exeFolder = './aexe_output_perf'
